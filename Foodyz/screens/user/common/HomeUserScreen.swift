            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        // Categories
                        HStack(spacing: 16) {
                            CategoryCard(icon: "bag.fill", title: "Takeaway", subtitle: "Pick up your food", color: AppColors.primary)
...
struct CategoryCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text(title).font(.system(size: 18, weight: .semibold)).foregroundColor(AppColors.darkGray)
